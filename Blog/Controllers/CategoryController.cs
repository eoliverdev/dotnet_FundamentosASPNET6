...
namespace Blog.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
            ...
            [FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05XE0 - Não foi possível alterar a categoria"));
            }
            catch (Exception ex)
            {
            ...
            [FromServices] BlogDataContext context)
        {
            ...
            try
            {
                ...
                if (category == null)
                    return NotFound(new ResultViewModel<Category>("Conteúdo não encontado!"));
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05XE1 - Não foi possível excluir a categoria"));
    }
            catch (Exception ex)
            {
                return StatusCode(500, new ResultViewModel<Category>("05X1 2- Falha interna no servidor"));
            }
        }
    }
}
